defmodule SessionizerWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(SessionizerWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(SessionizerWeb.Gettext, "errors", msg, opts)
    end
  end
